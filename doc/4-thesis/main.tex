...
\node[above] at (0,1.2) {Wellhead};

% Surface sensors (clean separation)
\node[left] at (-0.5,0.8) {WHT};
\node[above left] at (-0.5,1.2) {WHP};
...
\draw[thick] (0,0) .. controls (-0.3,-1.2) and (-1.5,-2.5) .. (-1.6,-2.6);
\node at (-0.5,-2.0) {Wellbore};

% Reservoir
\draw[thick] (-3.2,-4.3) ellipse (4.2cm and 2.1cm);
\node at (-3.2,-4.3) {Reservoir};

% Downhole sensors (spaced properly)
\node[right] at (-1.6,-3.9) {DHP};
\node[right] at (-1.6,-4.3) {DHT};

\draw (-2.2,-3.9) circle (0.08);
\draw (-2.2,-4.3) circle (0.08);

\end{tikzpicture}
\caption{Well Flow Measurement Instrumentation Setup}
