...
\begin{figure}[!htb]
\uomFig{W10 - downhole pressure}{fig:dhp}{\includegraphics[width=0.5\textwidth]{images/W10_dhp.png}}{}
\end{figure}

\begin{figure}[!htb]
\uomFig{W10 - downhole temperature}{fig:dht}{\includegraphics[width=0.5\textwidth]{images/W10_dht.png}}{}
\end{figure}

\begin{figure}[!htb]
\uomFig{W10 - wellhead pressure}{fig:whp}{\includegraphics[width=0.5\textwidth]{images/W10_whp.png}}{}
\end{figure}

\begin{figure}[!htb]
\uomFig{W10 - wellhead temperature}{fig:wht}{\includegraphics[width=0.5\textwidth]{images/W10_wht.png}}{}
\end{figure}
...
All code implementations, experimental results, supporting documentation, and supplementary literature associated with this research are publicly available in the GitHub repository
\url{https://github.com/pcperera/vfm}. This repository is maintained by the author and serves as the primary reference for the computational aspects of this thesis.
