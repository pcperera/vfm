...
Gas production is modeled using a pressure-drop-driven relationship modulated by choke effectiveness. In producing wells, gas flow is strongly influenced by reservoir pressure drawdown and surface flow restrictions imposed by choke settings. Classical gas deliverability theory shows that gas flow rate depends on pressure differences (or pressure-squared differences) between the reservoir and the wellbore \citep{ahmed2010reservoir, rawlins1935backpressure}.
