...
It is important to distinguish temporal reconstruction from forecasting. In the
proposed framework, reconstruction operates exclusively on historical timestamps for
which all independent variables (pressures, temperatures, choke settings, and lagged
features) are available. No extrapolation beyond the observed time horizon is performed.
