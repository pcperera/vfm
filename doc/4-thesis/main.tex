...
\hline
$R^2$ & 1.00 & -1.87 & 0.99 & 0.99 & 0.73 & 0.98 & 0.88 \\
...
\hline
$R^2$ & 1.00 & -7.08 & 0.99 & 0.85 & 0.95 & -0.72 & 0.86 \\
...
\multicolumn{8}{c}{Hybrid Model} \\
\hline
$R^2$ & 1.00 & 0.44 & 0.97 & 0.99 & 0.79 & 0.99 & 0.85 \\
...
Table~\ref{tab:lowo} summarizes the spatial generalization performance for the held-out well.

\begin{table}[!ht]
\centering
\caption{Spatial generalization (LOWO) performance for held-out well}
\label{tab:lowo}
\begin{tabular}{lccccc}
\hline
Quantity & Model & $R^2$ & MAE & RMSE & MAPE (\%) \\
\hline
$q_o$ & Physics & 0.07 & 20.26 & 29.53 & 20.22 \\
      & Hybrid  & 0.54 & 15.15 & 20.71 & 14.87 \\
      & MPFM    & 0.97 & 3.12  & 5.57  & 2.86 \\
\hline
$q_g$ & Physics & 0.32 & 2424.02 & 3036.39 & 19.16 \\
      & Hybrid  & 0.36 & 2334.83 & 2945.92 & 17.89 \\
      & MPFM    & 0.95 & 494.63  & 862.86  & 3.43 \\
\hline
$q_w$ & Physics & -0.24 & 5.35 & 12.09 & 100.00 \\
      & Hybrid  & -0.30 & 4.89 & 12.41 & 10756.85 \\
      & MPFM    & 0.93 & 2.42 & 2.86 & 89823.80 \\
\hline
\end{tabular}
\end{table}
...
Across both temporal and spatial generalization scenarios, the following trends are observed:

\begin{itemize}
    \item The hybrid model consistently outperforms the physics-only baseline for oil and gas rate prediction.
    \item Performance gains are most pronounced under temporal generalization, indicating strong within-well residual stationarity.
    \item Spatial generalization remains more challenging, reflecting well-specific heterogeneity not captured by shared residual structures.
    \item Water-related quantities exhibit the highest uncertainty across all models, particularly during regime transitions.
    \item MPFM provides superior accuracy but relies on dense instrumentation not available in many field settings.
\end{itemize}
