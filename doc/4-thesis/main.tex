...
\begin{table}[!htb]
\centering
\caption{Performance comparison on Well W10 against well test (reference) rates}
\label{tab:w10_comparison}
\begin{tabular}{lcccc}
\hline
\textbf{Rate} & \textbf{Model} & $\mathbf{R^2}$ & \textbf{RMSE} & \textbf{MAE} \\
 &  &  & (Sm$^3$/h) & (Sm$^3$/h) \\
\hline
\multirow{3}{*}{Oil ($q_o$)}
 & Physics-only & 0.40 & 25.77 & 19.71 \\
 & Hybrid (Physics--ML) & \textbf{0.75} & \textbf{16.64} & \textbf{12.55} \\
 & MPFM & 0.97 & 5.53 & 4.02 \\
\hline
\multirow{3}{*}{Gas ($q_g$)}
 & Physics-only & 0.72 & 2320.17 & 1677.23 \\
 & Hybrid (Physics--ML) & \textbf{0.91} & \textbf{1306.14} & \textbf{1027.52} \\
 & MPFM & 0.95 & 974.13 & 453.14 \\
\hline
\multirow{3}{*}{Water ($q_w$)}
 & Physics-only & 0.10 & 7.28 & 3.22 \\
 & Hybrid (Physics--ML) & \textbf{0.30} & \textbf{6.41} & \textbf{2.51} \\
 & MPFM & 0.83 & 3.22 & 2.71 \\
\hline
\end{tabular}
\end{table}
