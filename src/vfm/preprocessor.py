...
class Preprocessor:
    ...
    def preprocess(self):
        ...
        # fields_to_drop_na = ["qo_well_test", "qg_well_test", "qw_well_test"]
        df = df[["dhp", "dht", "whp", "wht", "choke", "dcp", "qo_mpfm", "qg_mpfm", "qw_mpfm", "qo_well_test", "qg_well_test", "qw_well_test"]]
